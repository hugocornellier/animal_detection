          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSection(context, 'Animal Detection / Body Pose', [
                  _buildModeCard(
                    context,
                    icon: Icons.videocam,
                    title: 'Live Camera',
                    description: 'Real-time animal detection from camera feed',
                  ...
                  _buildModeCard(
                    ...
                    title: 'Still Image',
                    description:
                        'Detect animals in photos from gallery or camera',
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                  ...
                  _buildModeCard(
                    ...
                    title: 'Video File',
                    description:
                        'Process an MP4 frame-by-frame with smoothed animal detection',
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
...
class _StillImageScreenState extends State<StillImageScreen> {
  ...
  static const List<String> _samplePaths = [
    'assets/samples/sample_animal_1.png',
    'assets/samples/sample_animal_2.png',
    'assets/samples/sample_animal_3.png',
    'assets/samples/sample_animal_4.png',
    'assets/samples/sample_animal_5.png',
  ];
